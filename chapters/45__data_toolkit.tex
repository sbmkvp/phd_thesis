...
The visualisations need to be highly processed, simplified and interactive to present meaning to the viewer. 
...
%-------------------------------------------------------------------------------
% Dicuss the data we have in detail 
%-------------------------------------------------------------------------------
...
\begin{table}[h]
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Comparison of volumes of the datasets collected for the research in Gigabytes per day.}
