...
The primary reason for veracity in the W-Fi data comes from the fact that the data is collected passively through a set of independent sensors operating in remote locations which leads to uncertainties and inaccuracies.
The Wi-Fi probe requests are generated by the mobile devices for purposes other than footfall analysis leading to noise and 
The first source of veracity originates from the unreliability of the data collection process.
The data is collected through a set of sensors located in multiple locations which communicate to the central server using 3G mobile data connectivity.
...
% Figure: Showing Mac Randomisation problem
