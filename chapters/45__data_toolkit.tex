...
But when we analyse these data at such scale, we also encounter a large amount of added complexity and cost \cite{gandomi2015beyond}.
...
The overall approach, methods, tools should comply with relevant legislation such as G.D.P.R as well as the research ethics of all the stakeholders.
...
\subsection{How big are the datasets of Wi-Fi probe requests?}

In this section we take a detailed look at the Wi-Fi datasets collected in the research using the 5Vs big data framework.
Out aim is to understand the nature of the data thus the challenges we will face processing and managing it.
We want to answer the following questions,
Can the Wi-Fi data be defined as Big data?
...
First we look at the Wi-Fi data in each dimension and then arrive at a general categorisation of the data.
...
\begin{table}[h]
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Comparison of volume of the datasets of Wi-Fi probe requests.}
